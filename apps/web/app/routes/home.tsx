    ...
    <div className="landing-container">
      ...
      <section className="hero-section">
        ...
        <p className="hero-subtitle">
          Empowering intentional living by turning every moment into an opportunity for conscious choice. 
          Experience the weightless agency of a tool that moves with you.
        </p>
        <div className="flex gap-4 mb-20 animate-fadeIn" style={{ animationDelay: '0.5s', animationFillMode: 'both' }}>
          <Button size="lg" onClick={onLaunch} className="btn-primary-gradient px-10 h-14 rounded-2xl text-lg">
            Enter the OS
          </Button>
          <Button size="lg" variant="ghost" className="h-14 px-8 text-lg rounded-2xl group">
            Learn More <ArrowRightIcon className="ml-2 size-5 group-hover:translate-x-1 transition-transform" />
          </Button>
        </div>
        ...
        <div className="values-grid">
          <div className="glass-card">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Remove the friction between thought and action. Our tool makes it easy to do what you truly want to do.
            </p>
          </div>
          <div className="glass-card">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Moving with the world, not against it. When states change, your plan evolves without guilt.
            </p>
          </div>
          <div className="glass-card">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Success is staying true to your mission. We prioritize the "Why" behind every single task.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="py-20 border-t border-border/50 text-center">
        <p className="text-sm font-mono text-muted-foreground uppercase tracking-widest mb-4">
          © 2026 KREOZALABS // INTENTIONAL OS
        </p>
        <p className="mission-text">"You cannot change what happened, but you can influence what you are about to do."</p>
      </footer>
    </div>
  );
}
