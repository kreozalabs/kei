...
function QRCodeCanvas({ text }: { text: string }) {
  ...
  return (
    <div className="flex justify-center p-3 bg-white rounded-xl border border-border/40 w-fit mx-auto shadow-sm">
      <canvas ref={canvasRef} className="rounded-lg size-[200px]" />
    </div>
  );
}
                ...
                <div className="space-y-5 py-4">
                  ...
                  {isCameraActive ? (
                    <div className="space-y-4">
                      <div className="relative w-full aspect-video max-w-[280px] mx-auto overflow-hidden rounded-xl border border-primary bg-black flex items-center justify-center">
                        <video
                          ref={videoRef}
                        ...
                        <div className="absolute inset-0 border border-primary/20 rounded-xl pointer-events-none overflow-hidden">
                          <div className="absolute top-0 left-0 w-full h-[2px] bg-primary shadow-[0_0_8px_var(--color-primary)] animate-scan" />
                        </div>
                      </div>
                      <Button
                        variant="outline"
