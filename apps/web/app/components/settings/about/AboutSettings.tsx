  ...
  const navigationLinks = [
    {
      ...
      icon: <KreozaLogo className="group-hover:text-foreground size-8 transition-colors" />,
      external: true,
    },
    {
      title: "Kei Calendar",
    ...
    },
    {
      ...
      icon: <GitHub className="group-hover:text-foreground size-8 transition-colors" />,
      external: true,
    },
    {
      ...
      icon: <Sparkles className="group-hover:text-foreground size-8 transition-colors" />,
      external: true,
    },
    {
      title: "Open Source License",
      description: "Licensed under GNU AGPLv3. View full license terms and permissions.",
      icon: <ShieldCheck className="group-hover:text-foreground size-8 transition-colors" />,
