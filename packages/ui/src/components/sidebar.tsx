...
import { useIsMobile } from "@kreozalabs/kei-ui/hooks/use-mobile";
import { cn } from "@kreozalabs/kei-ui/lib/utils";
import { Button } from "@kreozalabs/kei-ui/components/button";
import { Input } from "@kreozalabs/kei-ui/components/input";
import { Separator } from "@kreozalabs/kei-ui/components/separator";
import {
  Sheet,
  SheetContent,
  SheetDescription,
  SheetHeader,
  SheetTitle,
} from "@kreozalabs/kei-ui/components/sheet";
import { Skeleton } from "@kreozalabs/kei-ui/components/skeleton";
import { Tooltip, TooltipContent, TooltipTrigger } from "@kreozalabs/kei-ui/components/tooltip";
          ...
          style={
            {
              ...
              "--sheet-transition-duration": "var(--sidebar-transition-duration)",
              "--sheet-transition-ease": "var(--sidebar-transition-ease)",
            } as React.CSSProperties
          }
          side={side}
        >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-(--sidebar-width) bg-transparent transition-[width] duration-[var(--sidebar-transition-duration,500ms)] ease-[var(--sidebar-transition-ease,cubic-bezier(0.32,0.72,0,1))]",
      ...
      <div
        ...
        data-side={side}
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-[var(--sidebar-transition-duration,500ms)] ease-[var(--sidebar-transition-ease,cubic-bezier(0.32,0.72,0,1))] data-[side=left]:left-0 data-[side=left]:group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] data-[side=right]:right-0 data-[side=right]:group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)] md:flex",
